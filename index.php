...
$sql = 'INSERT INTO public."Product" (Id, Product_Name, Catergory, Date, Price, Descriptions) VALUES ('$id'::character varying(20), '$name'::character varying(100), '$cat'::character varying(40),'$date'::date,'$price'::integer,'$description'::character varying(200))";
'returning "Id"';
echo $sql;
