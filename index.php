...
$sql = "INSERT INTO Product (Id, Product_Name, Catergory, Date, Price, Descriptions) VALUES ('.$id'::character varying(20), '$name'::character varying(100), '$cat'::character varying(40),'$date'::date,'$price'::integer,'$desc'character varying(200))".'returning "Id"';
echo $sql;
